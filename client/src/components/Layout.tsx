...
const Layout: React.FC = () => {
    ...
    const navItems = [
        ...
        { path: '/crisis', icon: Heart, label: 'Apoyo Crisis', color: 'text-red-500' },
        { path: '/planning', icon: Calendar, label: 'Planificación' },
        { path: '/mood', icon: MessageCircle, label: 'Mi Ánimo' },
        { path: '/community', icon: Users, label: 'Comunidad' },
        { path: '/pomodoro', icon: Timer, label: 'Recreo Mental' },
    ];
